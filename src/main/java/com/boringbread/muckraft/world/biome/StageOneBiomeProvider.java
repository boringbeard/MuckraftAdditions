...
public class StageOneBiomeProvider extends BiomeProvider
{
    ...
    public static GenLayer[] initializeAllBiomeGenerators(long seed, WorldType worldType, ChunkGeneratorSettings chunkGeneratorSettings)
    {
        ...
        GenLayer genlayeredge = new GenLayerEdge(2L, genlayerremovetoomuchocean, GenLayerEdge.Mode.HEAT_ICE);
        ...
        {
            biomeSize = chunkGeneratorSettings.biomeSize;
            riverSize = chunkGeneratorSettings.riverSize;
        }
        ...
        GenLayer genlayersmooth1 = new GenLayerSmooth(1000L, genlayer);
